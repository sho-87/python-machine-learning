...
for i in range(data.shape[0]):
    data_temp[i,0,0,:] = data[i,0,0,:]  # Fp1
    data_temp[i,0,1,:] = data[i,0,13,:]  # Oz
    data_temp[i,0,2,:] = data[i,0,7,:]  # T8
    data_temp[i,0,3,:] = data[i,0,20,:]  # T7
...
if GRID_SEARCH:
    ...
    # Highest search accuracy: 56.00%
    # Best kernel size: (3,17)
    ...
    # Final test accuracy: 64.62%
else:
    cur_test_acc = main(batch_size=200, num_epochs=300, k_height=3, k_width=17)
